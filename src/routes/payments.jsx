...
function PaymentsPage() {
    ...
    return (<main className="mx-auto max-w-4xl px-4 py-8">
      ...
      {orders.length === 0 ? (<div className="rounded-xl border bg-card p-12 text-center text-muted-foreground">No payments yet.</div>) : (<div className="rounded-xl border bg-card overflow-hidden">
