...
import { store, useStore, formatNGN, type Category, type SoupType } from "@/lib/store";
    ...
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div className="flex gap-2">
          {(["All", "Foods", "Protein"] as const).map((c) => (
...
function FoodCard({ food, left }: { food: ReturnType<typeof store.get>["foods"][number]; left: number }) {
  const [soup, setSoup] = useState<SoupType>("Egusi");
      ...
      <div className="p-4">
        ...
        {food.isSwallow && (
          <div className="mt-3">
            ...
            <select value={soup} onChange={(e) => setSoup(e.target.value as SoupType)} className="w-full rounded-md border bg-background px-2 py-1.5 text-sm">
