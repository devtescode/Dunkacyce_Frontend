...
function OrdersPage() {
    ...
    return (<main className="mx-auto max-w-4xl px-4 py-8">
      ...
      {orders.length === 0 ? (<div className="rounded-xl border bg-card p-12 text-center text-muted-foreground">
          ...
          {orders.map((o) => {
                ...
                return (<article key={o.id} className="rounded-xl border bg-card p-5">
                ...
                <div className="flex items-center gap-1 mb-4">
                  {STATUS_STEPS.map((s, i) => (<div key={s} className="flex items-center flex-1 last:flex-none">
